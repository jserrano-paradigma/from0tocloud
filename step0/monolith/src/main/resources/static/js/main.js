const mockData = false; //Set this variable to false in order to call service
...
function getOrderLinesModel(){
	$.getJSON("/watto/interfaces/orderLines.json", function(data){
		orderLines = data;
	}).fail(function(e){
...
function getOrderModel(){
	$.getJSON("/watto/interfaces/order.json", function(data){
		order = data;
	}).fail(function(e){
...
function getOffersAppliedModel(){
	$.getJSON("/watto/interfaces/offerApplied.json", function(data){
		offerApplied = data;
	}).fail(function(e){
...
function getServices(){
	$.ajax({
		type: 'GET',
		url: baseurl + urlservices,
	}).then(function(data) {
		try{
			services = data._embedded.services;
